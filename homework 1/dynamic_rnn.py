...
class dynamicRNN(nn.Module):
    def __init__(self, embed_dim, hidden_dim, num_layers=1, bidirectional=False):
        super(dynamicRNN, self).__init__()

        self.rnn = nn.GRU(embed_dim, hidden_dim, batch_first=True, num_layers = num_layers,
